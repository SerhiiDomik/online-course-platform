...
class FormTests(TestCase):
    ...
    def test_course_form_valid(self):
        form_data = {"name": "Test Course", "description": "This is a test course."}
    ...
    def test_lesson_form_valid(self):
        ...
        self.assertEqual(
            lesson_instance.content, "This is the content of the test lesson."
        )
...
class TestCourseSearchForm(TestCase):
    ...
    def test_search_course_by_name(self):
        response = self.client.get(
            reverse("course:course-list"), {"name": "Python for Beginners"}
        )
